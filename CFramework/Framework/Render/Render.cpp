#include "Render.hpp"
#include "../ImGui/Fonts/RobotoRegular.h"
#include "../ImGui/Custom.h"

void CRenderer::ApplyStyle()
{
	// ImGui io setting
	...
	m_fIcon = io.Fonts->AddFontFromMemoryCompressedTTF(FA_compressed_data, FA_compressed_size, 16.f, &icons_config, icons_ranges);
	io.Fonts->Build();
}
